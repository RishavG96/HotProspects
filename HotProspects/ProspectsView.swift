...
struct ProspectsView: View {
    ...
    @State private var isShowingConfirmationDiaglog = false
    ...
    var body: some View {
        NavigationView {
            ...
            .toolbar {
                Button {
                    isShowingConfirmationDiaglog = true
                } label: {
            ...
            .confirmationDialog("Sort the users", isPresented: $isShowingConfirmationDiaglog) {
                Button("Sort by name") {  }
